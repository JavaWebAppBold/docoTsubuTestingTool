...
public class TopPageTestCase extends TestCase {
	...
	public TopPageTestCase(NetClient client) {
		...
		this.param = TestParameter.builder().operation(Operation.of(this.tergetCommand)).build();
		expected = RootPathAccessCommandResult.builder().httpStatus(200).body("action=\"/docoTsubu/Login\"").build();
