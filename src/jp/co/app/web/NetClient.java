...
public class NetClient {
	...
	// private WebRequestBuilder requestBuilder;
	...
	private NetClient(Url domain) {
		this.clear();
		this.domain = domain;
		// this.requestBuilder = WebRequestBuilder.of();
	}
	public void clear() {
	...
	public void post(String path) {
		...
		var uri = URI.create(this.domain.toString());
		// var request = this.requestBuilder.post(uri);
	...
	public void post(String path, WebQuery param) {
		...
		var request = HttpRequest.newBuilder(uri)
			...
			.POST(HttpRequest.BodyPublishers.ofString(param.toQuery()))
			.build();
		NetResult result = null;
		try {
			var response = this.send(request);
